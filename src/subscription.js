    ...
    <div className="UiForge" style={{ width: '100vw', height: '100vh', position: 'relative', background: 'white' }}>
      ...
      <div className="DivMainContainer" style={{ width: 1000, height: 1080, left: 999.50, top: 0, position: 'absolute' }}>
        <div className="Heading3" style={{ width: 400, height: 33, left: 280, top: 303.50, position: 'absolute' }}>
          <div className="Subscribe" style={{ width: 250.61, height: 33, left: 74.89, top: 0, position: 'absolute', textAlign: 'center', color: '#005463', fontSize: 28, fontFamily: 'Public Sans', fontWeight: '400', wordWrap: 'break-word' }}>Register</div>
        </div>
        ...
        <div className="Form" style={{ width: 400, height: 292, left: 280, top: 336.50, position: 'absolute' }}>
          ...
          <div className="Input" style={{ width: 400, height: 38, position: 'absolute', top: 158, background: 'white', borderRadius: 2, border: '1px #A4A4A4 solid', boxSizing: 'border-box', padding: '0 10px' }}>
            <input type="email" placeholder="Email" style={{ width: 'calc(100% - 20px)', height: '100%', padding: 0, fontSize: 14, color: '#989898', fontFamily: 'Public Sans', fontWeight: 400, border: 'none', outline: 'none' }} />
          </div>
          ...
          <Link to="/login">
            <button className="Button" style={{ width: 400, height: 34, position: 'absolute', top: 320, left: 0, background: '#05758A', borderRadius: 20, overflow: 'hidden', border: '1px #05758A solid', color: 'white', fontSize: 14, fontFamily: 'Public Sans', fontWeight: 600 }}>Register</button>
          </Link>
          <Link to="/">
          <button className="BackButton" style={{ width: 400, height: 34, position: 'absolute', top: 370, left: 0, background: 'lightgray', borderRadius: 20, overflow: 'hidden', border: '1px lightgray solid', color: 'black', fontSize: 14, fontFamily: 'Public Sans', fontWeight: 600 }}>Back to Home</button>
        </Link>
        </div>
      </div>
    </div>
